...
def SMT_Environment(security_control_list,selected_security_controls,threat_action_name_list,threat_action_list,
    ...
    for cost_iteration_index in range(ProjectConfigFile.COST_MODEL_ITERATION):
        ...
        Utitilities.appendTimeRiskStatsInFile([number_of_unique_asset,global_estimated_risk,affordable_risk,global_min_risk,
                                               ...
                                               risk_elimination,Utitilities.determineSizeCandidateSet(selected_security_controls),ProjectConfigFile.BINARY_MODIFIED_SEARCH],max_sec_control_threat_action_index)
