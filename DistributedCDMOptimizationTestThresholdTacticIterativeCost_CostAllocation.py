...
def SMT_Environment(security_control_list,selected_security_controls,threat_action_name_list,threat_action_list,
    ...
    for cost_iteration_index in range(ProjectConfigFile.COST_MODEL_ITERATION):
        ...
        for model_iteration_index in range(ProjectConfigFile.ITERATION_MODEL_SATISFACTION):
            ...
            """ Components should be in (Asset,Total Risk,Affordable Risk,Maximum Achievable Risk,Residual Risk,Implementation Cost,Computation Time in Sec,Number of Selected Countermeasures,Approach) Format"""
            Utitilities.appendStatsInFile([number_of_unique_asset, global_estimated_risk,affordable_risk_variable,global_min_risk,
                                           ...
                                           ProjectConfigFile.ITERATIVE_COST_ALLOCATION_SEARCH])
